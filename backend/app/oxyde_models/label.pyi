...
class OxydeLabel(Model):
    ...
    created_at: datetime
    objects: ClassVar["OxydeLabelManager"]
...
class OxydeLabelQuery(Query[OxydeLabel]):
    ...
    def order_by(self, *fields: Literal["color", "-color", "created_at", "-created_at", "description", "-description", "id", "-id", "name", "-name", "team_id", "-team_id"]) -> "OxydeLabelQuery":  # type: ignore[override]
    ...
    def select(self, *fields: Literal["color", "created_at", "description", "id", "name", "team_id"]) -> "OxydeLabelQuery":  # type: ignore[override]
    ...
    def group_by(self, *fields: Literal["color", "created_at", "description", "id", "name", "team_id"]) -> "OxydeLabelQuery":  # type: ignore[override]
        """Add GROUP BY clause."""
        ...
    ...
    def values(self, *fields: Literal["color", "created_at", "description", "id", "name", "team_id"]) -> "OxydeLabelQuery":  # type: ignore[override]
        """Return dicts instead of models."""
        ...

    def values_list(self, *fields: Literal["color", "created_at", "description", "id", "name", "team_id"], flat: bool = False) -> "OxydeLabelQuery":  # type: ignore[override]
