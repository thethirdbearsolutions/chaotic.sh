...
Using SQLite with SQLAlchemy async and Alembic for migrations.
...
New databases need to:
1. Run `alembic upgrade head` to create all tables and apply migrations

### Important Notes

- **Always backup before migrations**: `cp chaotic.db chaotic.backup.db`
- Review autogenerated migrations - they may need manual adjustment
